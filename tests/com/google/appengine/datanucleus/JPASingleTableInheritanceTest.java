...
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Child11;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Child11Many;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Child12;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Child21;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Child22;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.ChildBoolIntDiscriminator;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.ChildDateIntDiscriminator;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.ChildToParentWithoutDiscriminator;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Embedded1;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Embedded2;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.Parent;
import com.google.appengine.datanucleus.test.SingleTableInheritanceJPA.ParentIntDiscriminator;
...
public class JPASingleTableInheritanceTest extends JPATestCase {
  ...
  private void testQueryParent(StartEnd startEnd) {
    ...
    startEnd.start();
    Query q = em.createQuery("select from " + Parent.class.getName() + " where id = :id");
    ...
    startEnd.start();
    q = em.createQuery("select from " + Parent.class.getName() + " where id = :id");
