...
import com.google.appengine.datanucleus.test.jdo.BidirectionalChildLongPkJDO;
import com.google.appengine.datanucleus.test.jdo.BidirectionalChildUnencodedStringPkJDO;
import com.google.appengine.datanucleus.test.jdo.Flight;
import com.google.appengine.datanucleus.test.jdo.HasExplicitIndexColumnJDO;
import com.google.appengine.datanucleus.test.jdo.HasKeyPkJDO;
import com.google.appengine.datanucleus.test.jdo.HasOneToManyJDO;
import com.google.appengine.datanucleus.test.jdo.HasOneToManyKeyPkJDO;
...
import com.google.appengine.datanucleus.test.jdo.HasOneToManyLongPkJDO;
import com.google.appengine.datanucleus.test.jdo.HasOneToManyUnencodedStringPkJDO;
import com.google.appengine.datanucleus.test.jdo.HasOneToManyWithOrderByJDO;
...
abstract class JDOOneToManyTestCase extends JDOTestCase {
  ...
  void testOnlyOneParentPutOnChildDelete(HasOneToManyJDO pojo, BidirectionalChildJDO bidir, StartEnd startEnd)
    ...
    if (startEnd == TXN_START_END) {
      // transactional, so 1 put to do all
      assertEquals(1, policy.putParamList.size());
    } else {
      // non-tx so 1 for each
      assertEquals(4, policy.putParamList.size());
    }
  }
