...
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirBottomList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirBottomLongPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirBottomStringPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirBottomUnencodedStringPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirMiddleList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirMiddleLongPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirMiddleStringPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirMiddleUnencodedStringPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirTopList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirTopLongPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirTopStringPkList;
import org.datanucleus.test.BidirectionalSingleTableChildListJPA.BidirTopUnencodedStringPkList;
...
import org.datanucleus.test.HasPolymorphicRelationsListJPA;
import org.datanucleus.test.HasPolymorphicRelationsListJPA.HasOneToManyKeyPkListJPA;
import org.datanucleus.test.HasPolymorphicRelationsListJPA.HasOneToManyListJPA;
import org.datanucleus.test.HasPolymorphicRelationsListJPA.HasOneToManyLongPkListJPA;
import org.datanucleus.test.HasPolymorphicRelationsListJPA.HasOneToManyStringPkListJPA;
import org.datanucleus.test.HasPolymorphicRelationsListJPA.HasOneToManyUnencodedStringPkListJPA;
import org.datanucleus.test.HasPolymorphicRelationsListJPA.HasOneToManyWithUnsupportedInheritanceList;
...
import org.datanucleus.test.UnidirectionalSingeTableChildJPA.UnidirBottom;
import org.datanucleus.test.UnidirectionalSingeTableChildJPA.UnidirMiddle;
import org.datanucleus.test.UnidirectionalSingeTableChildJPA.UnidirTop;

import java.util.Collections;

import static org.datanucleus.store.appengine.PolymorphicTestUtils.assertKeyParentEquals;
...
public class JPAOneToManyPolymorphicListTest extends JPAOneToManyPolymorphicTestCase {
  ...
  private void makePersistentWithExpectedException(StartEnd startEnd,
    ...
    try {
      ...
      assertTrue(uso.getMessage().contains("SINGLE_TABLE"));
    }
  }
  ...
  protected void registerSubclasses() {
	...
	getObjectManager().getClassLoaderResolver());
    getObjectManager().getStoreManager().addClass(BidirMiddleList.class.getName(),
	getObjectManager().getClassLoaderResolver());
    getObjectManager().getStoreManager().addClass(BidirBottomList.class.getName(),
	getObjectManager().getClassLoaderResolver());
  }
}
