...
import org.datanucleus.test.BidirectionalSuperclassTableChildJDO;
import org.datanucleus.test.BidirectionalSuperclassTableChildJDO.BidirTop;
import org.datanucleus.test.BidirectionalSuperclassTableChildJDO.BidirTopLongPk;
import org.datanucleus.test.BidirectionalSuperclassTableChildJDO.BidirTopUnencodedStringPkJDO;
...
import org.datanucleus.test.UnidirectionalSuperclassTableChildJDO;
...
abstract class JDOOneToManyPolymorphicTestCase extends JDOTestCase {
  ...
  void testSaveWithOrderBy(HasOneToManyWithOrderByJDO pojo,
    ...
    getObjectManager().getOMFContext().getPersistenceConfiguration()
