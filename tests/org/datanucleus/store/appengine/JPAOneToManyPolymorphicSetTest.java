...
import org.datanucleus.test.BidirectionalSingleTableChildSetJPA.BidirBottomLongPkSet;
import org.datanucleus.test.BidirectionalSingleTableChildSetJPA.BidirBottomSet;
import org.datanucleus.test.BidirectionalSingleTableChildSetJPA.BidirBottomUnencodedStringPkSet;
import org.datanucleus.test.BidirectionalSingleTableChildSetJPA.BidirMiddleLongPkSet;
import org.datanucleus.test.BidirectionalSingleTableChildSetJPA.BidirMiddleSet;
import org.datanucleus.test.BidirectionalSingleTableChildSetJPA.BidirMiddleUnencodedStringPkSet;
...
import org.datanucleus.test.HasPolymorphicRelationsSetJPA.HasOneToManyKeyPkSetJPA;
import org.datanucleus.test.HasPolymorphicRelationsSetJPA.HasOneToManyLongPkSetJPA;
import org.datanucleus.test.HasPolymorphicRelationsSetJPA.HasOneToManySetJPA;
import org.datanucleus.test.HasPolymorphicRelationsSetJPA.HasOneToManyUnencodedStringPkSetJPA;
...
public class JPAOneToManyPolymorphicSetTest extends JPAOneToManyPolymorphicTestCase {
  ...
  protected void registerSubclasses() {
	...
	getObjectManager().getClassLoaderResolver());
    getObjectManager().getStoreManager().addClass(BidirMiddleSet.class.getName(),
	getObjectManager().getClassLoaderResolver());
    getObjectManager().getStoreManager().addClass(BidirBottomSet.class.getName(),
	getObjectManager().getClassLoaderResolver());
  }
