...
public class JPAIdentifierFactory extends AbstractIdentifierFactory
{
            ...
            AbstractMemberMetaData relatedFmd, DatastoreIdentifier destinationId, boolean embedded, int fieldRole)
    {
        ...
        if (relatedFmd != null)
        {
            ...
            {
                identifier = newDatastoreFieldIdentifier(relatedFmd.getName() + getWordSeparator() + destinationId.getIdentifierName());
            }
                ...
                fieldRole == FieldRole.ROLE_MAP_VALUE)
            {
                ...
                {
                    // FK to other table
                    identifier = newDatastoreFieldIdentifier(ownerFmd.getName() + getWordSeparator() + destinationId.getIdentifierName());
                }
                else
                {
            ...
            else
            {
                ...
                identifier = newDatastoreFieldIdentifier(destinationId.getIdentifierName(), embedded, fieldRole);
            }
        }
        else
        {
            ...
            if (fieldRole == FieldRole.ROLE_OWNER)
            {
                identifier = newDatastoreFieldIdentifier(ownerFmd.getClassName(false) + getWordSeparator() + destinationId.getIdentifierName());
            }
            else if (fieldRole == FieldRole.ROLE_COLLECTION_ELEMENT ||
                fieldRole == FieldRole.ROLE_ARRAY_ELEMENT ||
                fieldRole == FieldRole.ROLE_MAP_KEY ||
